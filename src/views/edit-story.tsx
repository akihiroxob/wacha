...
export const EditStoryPage: FC<EditStoryPageProps> = ({ project, story, values, error }) => {
  return (
    <Layout>
      <main class="mx-auto flex w-full max-w-4xl flex-col gap-8 px-6 py-10 md:px-8">
        ...
        <section class="rounded-[2rem] border border-stone-200 bg-white px-6 py-8 shadow-sm md:px-8">
          <div class="flex flex-col gap-3">
            ...
            <h1 class="text-4xl font-semibold tracking-tight text-stone-900">Story を編集</h1>
        ...
        <form
          method="post"
          action={`/project/${project.id}/story/${story.id}`}
        ...
        >
          ...
          <label class="flex flex-col gap-2">
            ...
            <input
              type="text"
              name="title"
              value={values?.title ?? story.title}
