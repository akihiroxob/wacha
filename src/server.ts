...
app.get("/project/:projectId/task/:taskId/edit", PageCtrl.editTask.bind(PageCtrl));
...
app.post("/project/:projectId/task/:taskId", PageCtrl.updateTask.bind(PageCtrl));
...
app.post("/project/:projectId/task/:taskId/cancel", PageCtrl.cancelTask.bind(PageCtrl));
